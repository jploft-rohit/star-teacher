...
class BaseImageNetwork extends StatelessWidget {
  ...
  const BaseImageNetwork({Key? key, this.link, this.topMargin, this.bottomMargin, this.rightMargin, this.leftMargin, this.height, this.width, this.concatBaseUrl, this.borderRadius}) : super(key: key);
    ...
    return Padding(
      ...
      child: ClipRRect(
        ...
        child: Image.network((concatBaseUrl??true) ? ApiEndPoints().imageBaseUrl+(link??"") : (link??""),
          ...
          errorBuilder: (context, url, error) => Icon(Icons.image, size: width),
