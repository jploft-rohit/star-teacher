...
class _TimePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding: padding,
      child: Row(
        mainAxisAlignment: isShowdate?MainAxisAlignment.spaceAround:MainAxisAlignment.center,
...
class _HourControl extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    assert(debugCheckHasMediaQuery(context));
    final bool alwaysUse24HourFormat = true;
      ...
      child: Semantics(
        ...
        child: Center(
          child: Text(
            ...
            style: TextStyle(color: amSelected?Color(0xFF000000):Color(0xFFD1D1D1)),
            textScaleFactor: 0.6,
          ),
        ),
      ),
      ...
      child: Semantics(
        ...
        child: Center(
          child: Text(
            ...
            style: TextStyle(color: pmSelected?Color(0xFF000000):Color(0xFFD1D1D1)),
            textScaleFactor: 0.6,
          ),
        ),
      ),
...
class _TimePickerInputState extends State<_TimePickerInput> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final TimeOfDayFormat timeOfDayFormat = MaterialLocalizations.of(context).timeOfDayFormat(alwaysUse24HourFormat: true);
...
/// [Navigator.pop].
class TimePickerDialogs extends StatefulWidget {
  /// Creates a Material Design time picker.
  ///
  /// [initialTime] must not be null.
  const TimePickerDialogs({
    super.key,
  ...
  /// Restoration ID to save and restore the state of the [TimePickerDialogs].
  ///
  ...
  @override
  State<TimePickerDialogs> createState() => _TimePickerDialogsState();
}
...
class _TimePickerDialogsState extends State<TimePickerDialogs> with RestorationMixin {
  ...
  void _announceInitialTimeOnce() {
    ...
    _announceToAccessibility(
      context,
      localizations.formatTimeOfDay(widget.initialTime, alwaysUse24HourFormat: true),
    );
  ...
  Widget build(BuildContext context) {
    assert(debugCheckHasMediaQuery(context));
    final MediaQueryData media = MediaQuery.of(context);
    final TimeOfDayFormat timeOfDayFormat = localizations.timeOfDayFormat(alwaysUse24HourFormat: true);
    ...
    switch (_entryMode.value) {
      ...
      case TimePickerEntryMode.dialOnly:
        final Widget dial = Padding(
          padding: orientation == Orientation.portrait ? EdgeInsets.only(left: 50.0, right: 50.0, bottom: 0.0, top: 10.0) : const EdgeInsets.all(24),
