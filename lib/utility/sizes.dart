...
double bottomNavigationBarTs = 16.sp; // Bottom Navigation Bar Text Size - w400 (Done)
double floatingActionButtonTs = 15.sp; // Floating Action Button Text Size - w400 (Done)
...
double detailValueTs = 14.sp; // Detail Text Size - w700
...
double textFormFieldLabelTs = 15.sp; // TextFormField Title Size - w700 (Done)
double textFormFieldHintTs = 15.sp; // TextFormField Hint Size - w400 (Done)
double headingDropDownTs = 16.sp; // Top DropDown Title Size - w400 (Done)
...
const String toggleMediumButton = "toggleMediumButton";
