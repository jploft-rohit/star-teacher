class OnlineClassResponse {
  dynamic statusCode;
  dynamic message;
  List<OnlineClassRequestData>? data;
  Pagination? pagination;

  OnlineClassResponse(
      {this.statusCode, this.message, this.data, this.pagination});

  OnlineClassResponse.fromJson(Map<String, dynamic> json) {
...
class OnlineClassRequestData {
  ...
  OnlineClassRequestData.fromJson(Map<String, dynamic> json) {
    date = json['date'];
    time = json['time'];
