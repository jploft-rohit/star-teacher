class TodayScheduleResponse {
  dynamic statusCode;
  dynamic message;
  List<TodayScheduleData>? data;
  Pagination? pagination;

  TodayScheduleResponse({this.statusCode, this.message, this.data, this.pagination});

  TodayScheduleResponse.fromJson(Map<String, dynamic> json) {
    statusCode = json['statusCode'];
    message = json['message'];
    if (json['data'] != null) {
      data = <TodayScheduleData>[];
      json['data'].forEach((v) { data!.add(new TodayScheduleData.fromJson(v)); });
    }
...
class TodayScheduleData {
  ...
  TodayScheduleData({this.topics, this.isDeleted, this.sId, this.classType, this.school, this.subject, this.batch, this.classes, this.section, this.schoolStaff, this.schoolStaffUser, this.date, this.startTime, this.endTime, this.startDateTimeStamp, this.endDateTimeStamp, this.day, this.status, this.completeDateTime, this.createdBy, this.updatedBy, this.createdAt, this.updatedAt, this.iV, this.slot, this.startIn});

  TodayScheduleData.fromJson(Map<String, dynamic> json) {
