...
ELibraryQuestionResponse ELibraryQuestionResponseFromJson(String str) => ELibraryQuestionResponse.fromJson(json.decode(str));

String ELibraryQuestionResponseToJson(ELibraryQuestionResponse data) => json.encode(data.toJson());

class ELibraryQuestionResponse {
  int? statusCode;
  String? message;
  ELibraryQuestionData? data;
  Pagination? pagination;

  ELibraryQuestionResponse({
    this.statusCode,
    this.message,
    this.data,
    this.pagination,
  ...
  factory ELibraryQuestionResponse.fromJson(Map<String, dynamic> json) => ELibraryQuestionResponse(
    statusCode: json["statusCode"],
    message: json["message"],
    data: json["data"] == null ? null : ELibraryQuestionData.fromJson(json["data"]),
...
class ELibraryQuestionData {
  ...
  factory ELibraryQuestionData.fromJson(Map<String, dynamic> json) => ELibraryQuestionData(
    id: json["_id"],
