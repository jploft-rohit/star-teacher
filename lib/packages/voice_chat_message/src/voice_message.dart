...
import 'package:staff_app/packages/voice_chat_message/src/contact_noises.dart';
...
class _VoiceMessageState extends State<VoiceMessage>
  ...
  void _setDuration() async {
    ...
    print("_audioDuration");
    print(_audioDuration);

    if (_audioDuration == null) {
      // Handle the case where _audioDuration is null
      // This might be due to an issue with setUrl or widget.audioSrc
      return;
    }
  ...
  void _setAnimationConfiguration(Duration audioDuration) {
    ...
    if (widget.formatDuration != null) {
      ...
      // Handle the case where widget.formatDuration is null
    }
  }
