...
class _AttendanceListTileState extends State<AttendanceListTile> {
  ...
  Widget build(BuildContext context) {
    return Obx(()=>SmartRefresher(
      ...
      enablePullUp: true,
      onLoading: (){
        controller.getStarsAttendanceList(refreshType: "load");
      },
      onRefresh: (){
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(color: controller.selectedAttendanceTabIndex.value == 0 ? BaseColors.green : controller.selectedAttendanceTabIndex == 1 ? BaseColors.textRedColor : const Color(0xffEC9C00))),
                    child: IntrinsicHeight(
                      child: Row(
                        children: [
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child:BaseImageNetwork(
                                  link: controller.list?[index].student?.user?.profilePic??"",
                                  concatBaseUrl: false,
                                  height: 4.h,
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(toBeginningOfSentenceCase(controller.list?[index].attendanceType??"")??"", style: Style.montserratBoldStyle().copyWith(fontSize: 14.sp,
                                        color: controller.selectedAttendanceTabIndex == 0 ? BaseColors.green : controller.selectedAttendanceTabIndex == 1 ? BaseColors.textRedColor : const Color(0xffEC9C00)),),
                                    SizedBox(
                                      height: 0.5.h,
                                    ),
                          ...
                          VerticalDivider(color: controller.selectedAttendanceTabIndex == 0 ? BaseColors.green : controller.selectedAttendanceTabIndex == 1 ? BaseColors.textRedColor : const Color(0xffEC9C00)),
                          Expanded(
                            flex: 2,
                            child: GestureDetector(
                              onTap: (){
                                Get.to(ChatingScreen(
                                  ...
                                  uniqueId: controller.list?[index].student?.studentId??"",
                                ),
                                );
                              },
                              child: Column(
