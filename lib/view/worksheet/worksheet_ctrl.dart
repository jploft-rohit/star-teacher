...
import 'package:staff_app/view/worksheet/assignment_to_me_view/assignment_to_me_view.dart';

class WorkSheetCtrl extends GetxController{
  final selectedIndex = 0.obs;
  final selectedIndex1 = 0.obs;
  final RxInt primaryTabIndex = 0.obs;
  final RxInt secondaryTabIndex = 0.obs;
