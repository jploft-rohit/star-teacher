  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: BaseFloatingActionButton(
        ...
        title: translate(context).add_note,
      ),
      appBar: BaseAppBar(title: translate(context).my_notes),
      body: Padding(
        ...
        child: SmartRefresher(
          ...
          enablePullUp: true,
          onLoading: (){
            controller.getStickyNotesData(refreshType: "load");
          },
          onRefresh: (){
            controller.getStickyNotesData(refreshType: "refresh");
          },
              ...
              children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                BaseOverlays().showConfirmationDialog(
                                                    title: translate(context).are_you_sure_you_want_to_edit_this_note,
                                            ...
                                            GestureDetector(
                                                onTap: () {
                                                  BaseOverlays().showConfirmationDialog(
                                                          title: translate(context).are_you_sure_you_want_to_delete_this_note,
                                                          onRightButtonPressed: () {
                ...
                Obx(() => Visibility(
                      ...
                      child: Padding(
                        ...
                        child: Text(translate(context).completed,
                            style: TextStyle(
