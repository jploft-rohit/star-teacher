                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Text("G3 - Amira Khoury", style: Style.montserratBoldStyle().copyWith(color: CustomColors.primaryColor, fontSize: 15.sp),),
                        ),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Text("G4 - Rajiya Begum", style: Style.montserratBoldStyle().copyWith(color: CustomColors.primaryColor, fontSize: 15.sp),),
                        ),
                      ),
                    ],
                  ),
