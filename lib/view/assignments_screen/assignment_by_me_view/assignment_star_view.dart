...
class AssignmentStarView extends StatefulWidget {
  const AssignmentStarView({Key? key}) : super(key: key);

  @override
  State<AssignmentStarView> createState() => _AssignmentStarViewState();
}

class _AssignmentStarViewState extends State<AssignmentStarView> {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                CustomButton(text: translate(context).view_submissions.toUpperCase(), onPressed: (){
                  Get.to(SubmittedAssignmentView());
                }, borderRadius: 10.0,btnHeight: 40,),
                SizedBox(
                  height: 2.h,
                ),
              ],
