          ...
          : ListView.builder(
             ...
             return GestureDetector(
              onTap: (){
                ...
                Get.to(MCQScreen(title: widget.title, id: controller.list?[index]?.sId??"", isELibrary: true, isViewing:true));
              },
              child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      BaseEditDelete(
                        ...
                        /// On Edit
                        editTitle: controller.tabIndex.value == 1
                            ? ""
                            : "",
                        onEditProceed: (){
                        ...
                        /// On Delete
                        deleteTitle: controller.tabIndex.value == 1
                            ? ""
                            : "",
                        onDeleteProceed: (){
