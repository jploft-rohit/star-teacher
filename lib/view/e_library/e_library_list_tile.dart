            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Visibility(visible: controller.tabIndex.value == 0 || index == 0, child: BaseEditDelete(
                        heading: "Assignments 1",
                        editTitle: "edit assignment",
                        deleteTitle: "Delete Assignment",
                        onEditProceed: (){
                          BaseOverlays().dismissOverlay();
                          Get.to(const CreateELibraryAssignment(isEditing: true));
                        },
                    ...
                    Visibility(visible: controller.tabIndex.value == 1, child: BaseDetailData(detailsLabel: "Assignment To",detailsValue: "Rashid Khan (Nurse)",prefixIcon: "assets/images/family_img.svg")),
                    Row(
                    ...
                    const Divider(),
                    Visibility(visible: controller.tabIndex.value == 1,child: BaseDetailData(detailsLabel: "Due Date",detailsValue: "01/03/2022",prefixIcon: "assets/images/Vector (1).svg")),
                    Visibility(visible: controller.tabIndex.value == 1,child: BaseDetailData(detailsLabel: "Assigned Time",detailsValue: "9:30 AM",prefixIcon: "assets/images/time_icon.svg")),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                    ...
                    SizedBox(height: 1.h),
                    Visibility(
                      visible: controller.tabIndex.value == 0 || index == 0,
                      child: Row(
                        children: [
                          Expanded(
                            child: BaseButton(removeHorizontalPadding: true,leftMargin: 2.w,title: controller.tabIndex.value == 1 ? "STOP POST" : "POST".toUpperCase(), onPressed: (){
