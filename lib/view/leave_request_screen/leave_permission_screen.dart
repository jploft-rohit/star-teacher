          ...
          children: [
            ...
            Row(
              ...
              children: [
                Flexible(
                  flex: 1,
                  child: Text("${translate(context).out_time}:", style: Style.montserratBoldStyle().copyWith(fontSize: 16.sp, color: CustomColors.textBlackColor),),
                ),
                Flexible(
                  flex: 3,
                  child: Container(
            ...
            Row(
              ...
              children: [
                Flexible(
                  flex: 1,
                  child: Text("${translate(context).in_time}:", style: Style.montserratBoldStyle().copyWith(fontSize: 16.sp, color: CustomColors.textBlackColor),),
                ),
                Flexible(
                  flex: 3,
                  child: Container(
