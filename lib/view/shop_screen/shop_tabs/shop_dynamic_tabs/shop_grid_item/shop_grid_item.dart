                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            },child: Text(((addedItems(controller.list?[index])??0) == 0) ? "+ Add" : addedItems(controller.list?[index]).toString(),style: TextStyle(color: BaseColors.primaryColor,fontWeight: FontWeight.bold))),
                            Visibility(
                              visible: (addedItems(controller.list?[index])??0) > 0,
