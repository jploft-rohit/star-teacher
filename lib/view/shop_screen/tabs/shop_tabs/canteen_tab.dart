...
class CanteenTab extends StatefulWidget {
  const CanteenTab({super.key});

  @override
  State<CanteenTab> createState() => _CanteenTabState();
}

class _CanteenTabState extends State<CanteenTab> with SingleTickerProviderStateMixin{
