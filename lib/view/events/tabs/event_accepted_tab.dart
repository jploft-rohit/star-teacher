...
class EventsAcceptedTab extends StatefulWidget {
  const EventsAcceptedTab({Key? key}) : super(key: key);

  @override
  State<EventsAcceptedTab> createState() => _EventsAcceptedTabState();
}

class _EventsAcceptedTabState extends State<EventsAcceptedTab> {
  @override
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 2.h),
          Text(translate(context).accepted,style: TextStyle(fontWeight: FontWeight.w700,fontSize: primaryHeadingTs)),
          ListView.builder(
              itemCount: 10,
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Column(
                          children: [
                            Text(translate(context).accepted,style: TextStyle(fontSize: 14,color: Colors.green,fontWeight: FontWeight.w600)),
                            SizedBox(height: 5),
                            Text(translate(context).upcoming,style: TextStyle(fontSize: 11)),
                          ],
                        ),
                      ],
                    ),
