...
class _LostFoundTabState extends State<LostFoundTab> {
  ...
  Widget build(BuildContext context) {
    return Obx(()=>SmartRefresher(
      ...
      enablePullUp: true,
      onLoading: (){
        controller.getData(type: controller.selectedTabIndex.value == 0 ? "found" : "request", refreshType: "load");
      },
      onRefresh: (){
        controller.getData(type: controller.selectedTabIndex.value == 0 ? "found" : "request", refreshType: "refresh");
      },
