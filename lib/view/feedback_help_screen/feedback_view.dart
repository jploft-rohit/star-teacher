            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    addText("Can improve the Speed", 16.sp, CustomColors.textBlackColor, FontWeight.w700),
                    Row(
                      children: [
                        GestureDetector(
                          onTap: (){
                ...
                Row(
                  ...
                  children: [
                    ...
                    Flexible(child: buildInfoItems("Type", "Feedback"))
                  ],
                ),
                Divider(),
                Row(
                  ...
                  children: [
                    ...
                    Flexible(child: buildInfoItems("Feedback for", "Application"))
                  ],
                ),
                Divider(),
                Row(
