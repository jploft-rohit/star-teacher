...
class ChatStaffTab extends StatefulWidget {
  const ChatStaffTab({Key? key}) : super(key: key);

  @override
  State<ChatStaffTab> createState() => _ChatStaffTabState();
}

class _ChatStaffTabState extends State<ChatStaffTab> with SingleTickerProviderStateMixin{
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          addText("Teacher", 13.sp, BaseColors.primaryColor, FontWeight.w700),
                                          SizedBox(
                                            height: .5.h,
                                          ),
                                          RichText(
