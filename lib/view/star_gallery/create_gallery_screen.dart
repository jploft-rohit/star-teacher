                      ...
                      children: [
                        CustomFilterDropDown(
                          ...
                          onChange: (value) {
                            ...
                            baseCtrl.getClassSections(id: controller.selectedClass.value.sId??"");
                          },
                          icon: classTakenSvg,
                        ),
                        Container(
                      ...
                      if ((controller.image1?.value.path??"").isEmpty || (controller.image2?.value.path??"").isEmpty || (controller.image3?.value.path??"").isEmpty) {
                         await BaseOverlays().showMediaPickerDialog(
                             onCameraClick: (){
                               ...
                               ImagePicker().pickImage(source: ImageSource.camera,imageQuality: cameraQuality).then((value){
                                 if (value != null) {
                                   if((controller.image1?.value.path??"").isEmpty){
                             ...
                             onGalleryClick: (){
                             BaseOverlays().dismissOverlay();
                             ImagePicker().pickImage(source: ImageSource.gallery,imageQuality: galleryQuality).then((value){
                                 if (value != null) {
                                   if((controller.image1?.value.path??"").isEmpty){
                                     controller.image1?.value = value;
                                   }else if ((controller.image2?.value.path??"").isEmpty) {
