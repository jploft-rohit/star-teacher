        ...
        children: [
          ...
          Row(
              children: [
                ...
                SizedBox(width: 6),
                Text("Posted: ${getFormattedDate2(controller.list?[widget.index].createdAt??"")}, ${getFormattedTime(controller.list?[widget.index].createdAt??"")}",style: TextStyle(fontSize: 14.sp)),
              ]),
          SizedBox(height: 12),
          Container(
              width: 100.w,
